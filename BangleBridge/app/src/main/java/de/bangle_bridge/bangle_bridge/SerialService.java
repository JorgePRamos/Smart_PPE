...
public class SerialService extends Service implements SerialListener {
    ...
    public SerialService() {//Serial Service Constructor
    ...
    // BLE Api
    public void connect(SerialSocket socket) throws IOException {//Connection
        socket.connect(this);
        this.socket = socket;
        connected = true;
    }
    ...
    public void attach(SerialListener listener) {//Evaluate on BT attach
