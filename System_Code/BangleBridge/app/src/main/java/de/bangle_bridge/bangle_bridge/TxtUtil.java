...
/**
 * The text Util class used for debugging purpose of the BLE connection codes
 * @author Jorge
 * @version 1.5
 * @since 1.0
 */
final class TxtUtil {
    ...
    final static String newline_crlf = "\r\n";//Constant for crlf (retorno de carro + salto de linea)
    final static String newline_lf = "\n";//Constant for lf(salto de linea)

    //from hex
    static byte[] fromHexString(final CharSequence s) {//from hex
    ...
    static void toHexString(StringBuilder sb, final byte[] buf) {//to HEx
    ...
    /**
     * The HexWatcher class allows the input and translation of hexadecimal text.
     * @author Jorge
     * @version 1.5
     * @since 1.0
     */
